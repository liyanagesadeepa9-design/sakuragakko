...
const hiragana = {
    basic: [
        ...
        { character: "", romaji: "", sinhala: "" },
        { character: "", romaji: "", sinhala: "" },
        { character: "を", romaji: "wo", sinhala: "වො" },
    ...
    additional1: [
        ...
        { character: "ざ", romaji: "za", sinhala: "za" },
        { character: "じ", romaji: "ji", sinhala: "ජි" },
        { character: "ず", romaji: "zu", sinhala: "zu" },
        { character: "ぜ", romaji: "ze", sinhala: "ze" },
        { character: "ぞ", romaji: "zo", sinhala: "zo" },
        { character: "だ", romaji: "da", sinhala: "ඩ" },
        { character: "ぢ", romaji: "ji", sinhala: "ජි" },
        { character: "づ", romaji: "zu", sinhala: "zu" },
    ...
    additional2: [
        { character: "きゃ", romaji: "kya", sinhala: "ක්‍ය" },
        { character: "きゅ", romaji: "kyu", sinhala: "ක්‍යු" },
        { character: "きょ", romaji: "kyo", sinhala: "ක්‍යෝ" },
        { character: "しゃ", romaji: "sha", sinhala: "ෂ" },
        { character: "しゅ", romaji: "shu", sinhala: "ෂු" },
        { character: "しょ", romaji: "sho", sinhala: "ෂො" },
        { character: "ちゃ", romaji: "cha", sinhala: "ච" },
        { character: "ちゅ", romaji: "chu", sinhala: "චු" },
        { character: "ちょ", romaji: "cho", sinhala: "චො" },
        { character: "にゃ", romaji: "nya", sinhala: "න්‍යා" },
        { character: "にゅ", romaji: "nyu", sinhala: "න්‍යු" },
        { character: "にょ", romaji: "nyo", sinhala: "න්‍යෝ" },
        { character: "ひゃ", romaji: "hya", sinhala: "හ්ය" },
        { character: "ひゅ", romaji: "hyu", sinhala: "හ්යු" },
        { character: "ひょ", romaji: "hyo", sinhala: "හ්යො" },
        { character: "みゃ", romaji: "mya", sinhala: "ම්‍ය" },
        { character: "みゅ", romaji: "myu", sinhala: "ම්යු" },
        { character: "みょ", romaji: "myo", sinhala: "ම්යො" },
        { character: "りゃ", romaji: "rya", sinhala: "rya" },
        { character: "りゅ", romaji: "ryu", sinhala: "ryu" },
        { character: "りょ", romaji: "ryo", sinhala: "ryo" },
        { character: "ぎゃ", romaji: "gya", sinhala: "ග්‍ය" },
        { character: "ぎゅ", romaji: "gyu", sinhala: "ග්‍යු" },
        { character: "ぎょ", romaji: "gyo", sinhala: "ග්‍යෝ" },
        { character: "じゃ", romaji: "ja", sinhala: "ජ" },
        { character: "じゅ", romaji: "ju", sinhala: "ජු" },
        { character: "じょ", romaji: "jo", sinhala: "ජො" },
        { character: "びゃ", romaji: "bya", sinhala: "බ්‍ය" },
        { character: "びゅ", romaji: "byu", sinhala: "බ්‍යු" },
        { character: "びょ", romaji: "byo", sinhala: "බ්‍යෝ" },
        { character: "ぴゃ", romaji: "pya", sinhala: "ප්‍ය" },
        { character: "ぴゅ", romaji: "pyu", sinhala: "ප්‍යු" },
        { character: "ぴょ", romaji: "pyo", sinhala: "ප්‍යෝ" }
    ]
};
...
const katakana = {
    basic: [
        ...
        { character: "", romaji: "", sinhala: "" },
        { character: "", romaji: "", sinhala: "" },
        { character: "ヲ", romaji: "wo", sinhala: "වො" },
    ...
    additional1: [
        ...
        { character: "ザ", romaji: "za", sinhala: "za" },
        { character: "ジ", romaji: "ji", sinhala: "ජි" },
        { character: "ズ", romaji: "zu", sinhala: "zu" },
        { character: "ゼ", romaji: "ze", sinhala: "ze" },
        { character: "ゾ", romaji: "zo", sinhala: "zo" },
        { character: "ダ", romaji: "da", sinhala: "ඩ" },
        { character: "ヂ", romaji: "ji", sinhala: "ජි" },
        { character: "ヅ", romaji: "zu", sinhala: "zu" },
    ...
    additional2: [
        { character: "キャ", romaji: "kya", sinhala: "ක්‍ය" },
        { character: "キュ", romaji: "kyu", sinhala: "ක්‍යු" },
        { character: "キョ", romaji: "kyo", sinhala: "ක්‍යෝ" },
        { character: "シャ", romaji: "sha", sinhala: "ෂ" },
        { character: "シュ", romaji: "shu", sinhala: "ෂු" },
        { character: "ショ", romaji: "sho", sinhala: "ෂො" },
        { character: "チャ", romaji: "cha", sinhala: "ච" },
        { character: "チュ", romaji: "chu", sinhala: "චු" },
        { character: "チョ", romaji: "cho", sinhala: "චො" },
        { character: "ニャ", romaji: "nya", sinhala: "න්‍යා" },
        { character: "ニュ", romaji: "nyu", sinhala: "න්‍යු" },
        { character: "ニョ", romaji: "nyo", sinhala: "න්‍යෝ" },
        { character: "ヒャ", romaji: "hya", sinhala: "හ්ය" },
        { character: "ヒュ", romaji: "hyu", sinhala: "හ්යු" },
        { character: "ヒョ", romaji: "hyo", sinhala: "හ්යො" },
        { character: "ミャ", romaji: "mya", sinhala: "ම්‍ය" },
        { character: "ミュ", romaji: "myu", sinhala: "ම්යු" },
        { character: "ミョ", romaji: "myo", sinhala: "ම්යො" },
        { character: "リャ", romaji: "rya", sinhala: "rya" },
        { character: "リュ", romaji: "ryu", sinhala: "ryu" },
        { character: "リョ", romaji: "ryo", sinhala: "ryo" },
        { character: "ギャ", romaji: "gya", sinhala: "ග්‍ය" },
        { character: "ギュ", romaji: "gyu", sinhala: "ග්‍යු" },
        { character: "ギョ", romaji: "gyo", sinhala: "ග්‍යෝ" },
        { character: "ジャ", romaji: "ja", sinhala: "ජ" },
        { character: "ジュ", romaji: "ju", sinhala: "ජු" },
        { character: "ジョ", romaji: "jo", sinhala: "ජො" },
        { character: "ビャ", romaji: "bya", sinhala: "බ්‍ය" },
        { character: "ビュ", romaji: "byu", sinhala: "බ්‍යු" },
        { character: "ビョ", romaji: "byo", sinhala: "බ්‍යෝ" },
        { character: "ピャ", romaji: "pya", sinhala: "ප්‍ය" },
        { character: "ピュ", romaji: "pyu", sinhala: "ප්‍යු" },
        { character: "ピョ", romaji: "pyo", sinhala: "ප්‍යෝ" }
    ]
};
